...
const Songs = () => {
    ...
    const handleSongFormModal = () => setSongFormModal(!songFormModal);
    ...
    return <React.Fragment>
        {isLoading ?
            ...
            Object.keys(songs).length === 0 ? <>
                ...
                {/* song form modal */}
                {songFormModal && <SongFormModalComponent close={setSongFormModal} />}
...
const SongFormModalComponent = ({ close }) => {
    ...
    return (<div className="fixed inset-0 z-30 flex items-center justify-center w-full h-full">
        ...
        >
            {/* <input ref={register} name="" placeholder="" className="bg-gray-100 rounded-lg px-10 py-3"/> */}
            <input ref={register} name="name" type="text" placeholder="Song name" className="bg-gray-100 rounded-lg px-10 py-3" />
            ...
            <select ref={register} name="genre" type="" placeholder="Song Genre" className="bg-gray-100 rounded-lg px-8 py-3">
                <option>TODO: Get list of genre from database</option>
            </select>
