const Register = () => {
    return <div className="flex flex-col items-center justify-center px-4 py-8 space-y-8 bg-teal-900 shadow-xl rounded-lg">
        ...
        <button className="block bg-teal-700 text-white rounded-lg shadow-lg    px-3 py-2">Register</button>
